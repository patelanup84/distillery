...
if submit:
    ...
    query_string = """SELECT * FROM `ws-performance.sfmc.emails_totals` LIMIT 10"""
    df_sfmc = (bqclient.query(query_string).result().to_dataframe(bqstorage_client=bqstorageclient))
